...
public class FileOperations {
	 ...
	 * @return boolean
	 */
	public boolean isValidFolder(File path) {
		// Check if it is a reachable directory
		return path.exists() && path.isDirectory() && path.canWrite() && path.canRead();
	}
	 ...
	 * @return boolean
	 */
	public boolean isValidFile(File path) {
		// Check if it is a reachable file
		return path.exists() && path.isFile() && path.canWrite() && path.canRead();
	}
	 ...
	 */
	public File createDirectoryIfNotExists(String path) {
	 ...
	 * @return boolean
	 */
	public boolean fileConatins(String filePath, String searchString) {
	 ...
	 * @return
	 */
	public boolean appendToFile(String filePath, String stringtoadd) {
		try {
